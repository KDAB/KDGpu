...
android {
    namespace = "com.kdab.bindgroup_partially_bound"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        applicationId = "com.kdab.bindgroup_partially_bound"
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
tasks.register<Copy>("copyShaders") {
    from("../../../../assets/shaders/examples/bindgroup_partially_bound")
    into("src/main/shaders/examples/bindgroup_partially_bound")
}
