...
android {
    namespace = "com.kdab.depth_texture_lookup"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        applicationId = "com.kdab.depth_texture_lookup"
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
tasks.register<Copy>("copyShaders") {
    from("../../../../assets/shaders/examples/depth_texture_lookup")
    into("src/main/shaders/examples/depth_texture_lookup")
}
