...
class RenderToTextureSubpassDynamicRendering : public KDGpuExample::SimpleExampleEngineLayer
{
public:
protected:
...
private:
    ...
    KDGpu::RenderPassCommandRecorderWithDynamicRenderingOptions m_dynamicRenderPassOptions;
