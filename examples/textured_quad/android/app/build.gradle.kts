...
android {
    namespace = "com.kdab.textured_quad"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        applicationId = "com.kdab.textured_quad"
        minSdk = 32
        targetSdk = 32
        versionCode = 1
        versionName = "1.0"
...
tasks.register<Copy>("copyShaders") {
    from("../../../../assets/shaders/examples/textured_quad")
    into("src/main/shaders/examples/textured_quad")
}
