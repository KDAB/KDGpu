...
android {
    namespace = "com.kdab.hello_xr_multiview"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        applicationId = "com.kdab.hello_xr_multiview"
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
tasks.register<Copy>("copyShaders") {
    from("../../../../assets/shaders/examples/hello_xr_multiview")
    into("src/main/shaders/examples/hello_xr_multiview")
}
