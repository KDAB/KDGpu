...
android {
    namespace = "com.kdab.buffer_reference"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        applicationId = "com.kdab.buffer_reference"
        minSdk = 32
        targetSdk = 32
        versionCode = 1
        versionName = "1.0"
...
tasks.register<Copy>("copyShaders") {
    from("../../../../assets/shaders/examples/buffer_reference")
    into("src/main/shaders/examples/buffer_reference")
}
