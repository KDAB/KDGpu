...
android {
    namespace = "com.kdab.bindgroup_indexing"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        applicationId = "com.kdab.bindgroup_indexing"
        minSdk = 33
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
tasks.register<Copy>("copyShaders") {
    from("../../../../assets/shaders/examples/bindgroup_indexing")
    into("src/main/shaders/examples/bindgroup_indexing")
}
