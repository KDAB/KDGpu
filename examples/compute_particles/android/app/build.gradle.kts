...
android {
    namespace = "com.kdab.compute_particles"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        applicationId = "com.kdab.compute_particles"
        minSdk = 32
        targetSdk = 32
        versionCode = 1
        versionName = "1.0"
...
tasks.register<Copy>("copyShaders") {
    from("../../../../assets/shaders/examples/compute_particles")
    into("src/main/shaders/examples/compute_particles")
}
