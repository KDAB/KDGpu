...
android {
    namespace = "com.kdab.render_to_texture_subpass"
    compileSdk = 34
    ...
    defaultConfig {
        ...
        applicationId = "com.kdab.render_to_texture_subpass"
        minSdk = 32
        targetSdk = 32
        versionCode = 1
        versionName = "1.0"
...
tasks.register<Copy>("copyShaders") {
    from("../../../../assets/shaders/examples/render_to_texture_subpass")
    into("src/main/shaders/examples/render_to_texture_subpass")
}
