...
/*!
    \class PipelineCache
    \brief PipelineCache allows caching of pipelines as binary data.
    \ingroup public
    \headerfile pipeline_cache.h <KDGpu/pipeline_cache.h>

    <b>Vulkan equivalent:</b> [VkPipelineCache](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VkPipelineCache.html)
