/*
  ...
  SPDX-FileCopyrightText: <%= current_year %> Klarälvdalens Datakonsult AB, a KDAB Group company <info@kdab.com>
...
tasks.register<Copy>("copyShaders") {
    from("../../../../assets/shaders/examples/<%= name %>")
    into("src/main/shaders/examples/<%= name %>")
}
